...
class DLIOPostProcessor:
    def __init__(self, args) -> None:
        ...
        self.iostat_file = json.load(open(os.path.join(self.outdir, 'iostat.json'), mode='r'))
        self.per_epoch_stats = json.load(open(os.path.join(self.outdir, 'per_epoch_stats.json'), mode='r'))
    ...
    def verify_all_files_present(self):
        ...
        all_files = ['per_epoch_stats.json']
        for rank in range(self.comm_size):
            all_files.append(f'{rank}_loading_times.json')
            all_files.append(f'{rank}_processing_times.json')
    ...
    def process(self):
        for epoch, data in self.per_epoch_stats.items():
            pass
