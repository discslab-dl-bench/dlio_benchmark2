...
docker run -it --rm --name=$container_name --ipc=host --gpus $num_gpus -v $DATA_DIR:/workspace/dlio/data -v $OUTPUT_DIR:/workspace/dlio/output bert_dlio:latest /bin/bash run_dlio.sh $num_gpus
